...
class AboutMessagePassing < Neo::Koan
  ...
  ### meditate on this - underscore messages
  ...
  ### meditate on this - dynamic message passing
  # NOTE:
  #
  ...
  ### mediate on this - method_missing method
  ...
  ### meditate on this - catch particular undefined method, but pass others to super
